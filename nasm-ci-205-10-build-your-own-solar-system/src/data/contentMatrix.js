...
const output = {
  ...
  main: {
    ...
    exitEvent: {
      ...
      adTabAriaInstruction: 'Tab once with the right arrow to exit the game, or tab twice to return to the gameplay.',
      adTabAriaInstructionEndEvent: 'Tab once with the right arrow to learn more about our solar system, or tab twice to return to the gameplay.',
    ...
    events: {
      ...
      asteroidCol: {
        ...
        imgAlt: 'An image shows an asteroid breaking apart in an orange-tinted burst, sending smaller chunks of rocks flying out from the impact.',
        gotItButtonLabel: 'Got It',
        gotItButtonAriaRoleDescription:
          'Button, Press the center key to return to the game.',
        closeButtonAriaLabel: 'Close',
      ...
      cometCol: {
        ...
        imgAlt: 'An image shows a comet breaking apart in an orange-tinted burst, sending smaller chunks of rocks flying out from the impact.',
        gotItButtonLabel: 'Got It',
        gotItButtonAriaRoleDescription:
          'Button, Press the center key to return to the game.',
        closeButtonAriaLabel: 'Close',
    ...
    endEvents: {
      ...
      closeButtonAriaLabel: 'Close',
      closeButtonAriaRoleDescription: 'Button, Press the center key to select and return to the game',
